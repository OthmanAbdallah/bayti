...
void showRateModal(BuildContext context, String JobId, String UserId, String WorkerId,String UserName,String WorkerName,String? Service,String? area) {
...
if(uid==WorkerId){
 ...
 if (userSnapshot.exists && userSnapshot.data() != null ) {
   ...
   temp2= userSnapshot.data()!['rating'].toDouble();
   print("testabc6");
...
if (workerSnapshot.exists && workerSnapshot.data() != null) {
  ...
  old_jobCount=temp?.toDouble();
  print("test15");
  temp2= workerSnapshot.data()!['rating'].toDouble();
  print("test16");
  old_rating=temp2?.toDouble();
  print("test17");
double? new_rating=((old_rating!*old_jobCount!)+rating)/(old_jobCount+1);
